                        ...
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlSexo" runat="server" CssClass="lblFomulario" ToolTip="Selecione o sexo.">
                                ...
                                <tr id="tr_CidadeBrasileira" runat="server">
                                    ...
                                    <td align="left" width="80%">
                                        <asp:DropDownList ID="ddlCidadeOrigem" runat="server" DataTextField="Nome" DataValueField="Codigo"
                                            AppendDataBoundItems="true" ToolTip="Informe a cidade de origem.">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="80%">
                                        <asp:DropDownList ID="UfDropDownList" runat="server" DataTextField="Nome" DataValueField="Sigla"
                                            AppendDataBoundItems="true" ToolTip="Informar estado em que reside.">
                                            <asp:ListItem></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
